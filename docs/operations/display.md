# Display, rendering and panel control

Use this guide for the graphical session, HDMI output, Chromium, shared surfaces,
video/audio and panel controls, including their software and physical evidence limits.

Return to [Appliance operations](../operations.md). Provisioning is in
[Installation and diagnostics](installation.md); application services, playback
and schedules are in [Runtime and services](runtime.md).
